...
describe('Local File System Storage', function () {
  ...
  it('should send correct path to image when date is in Aug 2015', function (done) {
  ...
  describe('when a custom content path is used', function () {
    ...
    beforeEach(function () {
      config.paths.contentPath = config.paths.appRoot + '/var/devzilla';
      config.paths.imagesPath = config.paths.appRoot + '/var/devzilla/' + config.paths.imagesRelPath;
    });
