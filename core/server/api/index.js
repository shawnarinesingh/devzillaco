...
//
// The JSON API is integral to the workings of this app, regardless of whether you want to access data internally,
// from a theme, an app, or from an external app, you'll use the JSON API to do so.
...
http = function http(apiMethod) {
  return function apiHandler(req, res, next) {
    // We defined 2 properties for using as arguments in API calls:
    var object = req.body,
